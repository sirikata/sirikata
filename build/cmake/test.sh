...
export num=3
export numnum=9
python ../../scripts/runsim.py $numnum --duration=100s --receive-bandwidth=$bandwidth --send-bandwidth=$bandwidth --wait-additional=6 --flatness=.001 --capexcessbandwidth=false --object.queue=fairfifo --cseg-service-tcp-port=6234 --cseg-service-host=meru01 --cseg=uniform
