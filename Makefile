...
minimaldepends:
	uname | grep arwin && svn co http://sirikata.googlecode.com/svn/trunk/osx10.4 dependencies && tar -jx --directory dependencies --file dependencies/dotnet-protobufs*.bz2 && tar -jx --directory dependencies --file dependencies/FreeImage-*.bz2 && tar -jx --directory dependencies --file dependencies/curl*.bz2 && tar -jx --directory dependencies --file dependencies/boost*.bz2 && tar -jx --directory dependencies --file dependencies/ois*.bz2 && unzip -d dependencies dependencies/SDL-1.3*.zip && tar -jx --directory dependencies --file dependencies/ogre*.bz2 || echo "Linux system"
