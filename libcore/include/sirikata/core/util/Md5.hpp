...
Sirikata notes: the license given above is fine, but see
...
Modifications made for Sirikata are provided under the same BSD license as the
Sirikata code.
